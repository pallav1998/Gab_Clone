...
export default function ChildModal() {
  ...
  return (
    <React.Fragment>
    <Button  onClick={handleOpen} style={{height:"30px"}}> <IosShareIcon style={{color:"#2d3436",fontSize:"15px"}}/> <p style={{ margin:"5px",fontSize:"13px",fontWeight:"400", color:"black"}}> Share</p> </Button> <br />
    ...
    <div style={{}}>
      ...
      >
        <Box   sx={{ ...style, width: 200,borderRadius:2 }}>
          ...
          <Button style={{width:"200px",height:"30px"}}> <BookmarkIcon style={{color:"#2d3436" ,fontSize:"15px"}}/> <p style={{margin:"5px",fontSize:"13px",fontWeight:"400", color:"black"}}>Bookmark status</p> </Button><KeyboardArrowRightIcon/>
